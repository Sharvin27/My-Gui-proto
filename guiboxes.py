...
class SecondWindow(QWidget):
    def __init__(self):
        ...
        self.setGeometry(100,400,750,750)
        self.setWindowTitle("Vayu")
        
        self.pitch=QLabel("Pitch : ",self)
        self.pitch.setGeometry(200,400,100,100)

        self.yaw=QLabel("Yaw :",self)
        self.yaw.setGeometry(200,350,100,100)
        
        self.roll=QLabel("Roll : ",self)
        self.roll.setGeometry(200,450,100,100)

        self.textbox_a=QTextEdit(self)
        self.textbox_a.setGeometry(320,400,100,20)

        self.textbox_b=QTextEdit(self)
        self.textbox_b.setGeometry(320,350,100,20)

        self.textbox_c=QTextEdit(self)
        self.textbox_c.setGeometry(320,450,100,20)
